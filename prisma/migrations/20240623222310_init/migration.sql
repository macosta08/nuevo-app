-- CreateEnum
CREATE TYPE "Enum_RoleName" AS ENUM ('Superadmin', 'Admin', 'Medico', 'Paciente');

-- CreateTable
CREATE TABLE "HST_examenesRealizados" (
    "id" TEXT NOT NULL,
    ...
    CONSTRAINT "HST_examenesRealizados_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "TMP_examenesRealizados" (
    "id" TEXT NOT NULL,
    "typeDocument" TEXT NOT NULL,
    "nameProcess" TEXT NOT NULL,
    "idExamen" TEXT,
    ...
    CONSTRAINT "TMP_examenesRealizados_pkey" PRIMARY KEY ("id")
);
